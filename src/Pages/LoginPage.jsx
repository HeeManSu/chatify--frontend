...
const LoginPage = () => {
    ...
    return (
        <div className="flex flex-col lg:flex-row h-screen">
            <div
                className="w-full h-28 md:h-16 login-mobile-bg block lg:hidden"
            >
            ...
            <div
                className="backgroundimage w-1/2 hidden lg:block"
            >
            ...
            <div className="h-full w-full lg:w-1/2 flex items-center justify-center">
                <div className="border-gray-200 shadow1 rounded-lg p-8 border w-auto lg:w-1/2">
                    ...
                    <div >
                        ...
                        <h1 className='text-start pt-2.5 cursor-pointer font-semibold' > New user? {" "}
